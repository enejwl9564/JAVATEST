...
//메서드 기본구조	? 헤더(반환자료형 함수명 (파라미터..))+바디(로직)
//메서드 오버로딩	? 메서드 파라미터의 형태를 다양하게 둘 수 있도록 허용한 문법
//지역변수			? {}내에서 선언되는 변수, {}를 벗어나면 기본적으로 소멸
//생성자			? 객체 생성시 1회 호출, 기본값 Setup 사용 메서드
//생성자 오버로딩	? 생성자 함수의 파라미터형을 다양하게 허용함으로써 외부로 부터의 다양한 초기값을 허용